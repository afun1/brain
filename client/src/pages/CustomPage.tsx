...
export default function CustomPage() {
  ...
  return (
    <div className="relative min-h-screen bg-background overflow-hidden flex flex-col">
      <WaveVisualizer isPlaying={audio.isPlaying} beatFrequency={audio.beatFreq} />
      ...
      <main className="flex-1 relative z-10 flex flex-col items-center justify-start px-4 py-8 pb-48 overflow-y-auto">
        ...
        >
          <div className="text-center mb-8">
            ...
            <p className="text-muted-foreground">Adjust the left ear (carrier) and binaural beat to create your own frequency combination</p>
          </div>
